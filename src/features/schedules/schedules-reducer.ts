...
import { SchedulesModel } from "./schedules-types";
import { createExerciseWithSpreadedSet } from "./utils";
...
const schedulesReducer = (oldState: SchedulesState = initialState, action: SchedulesActions): SchedulesState => {
  switch (action.type) {
