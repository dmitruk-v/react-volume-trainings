import { createSetId, createExerciseId, createTrainingId, } from "./create-schedule";
import { ExSetModel, ExerciseModel, TrainingModel, TrainingDayModel, TrainingWeekModel } from "../schedules-types";
